  ...
  const source = {
    ...
    body: data.subdomains.map((domain) => {
      return [
        ...
        `<a href="/maintainers/${domain.domain.split(".is-cool.me")[0]}">Edit</a>`
      ];
    })
  };
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<h2 class="h2">Staff Domains (${escape(data.count)})</h2>
<br>
...
//# sourceMappingURL=_page.svelte-0fc48f85.js.map
